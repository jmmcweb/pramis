...
const defaultServices: ServiceItem[] = [
  { title: 'Basic Consultation', subtitle: 'Monday to Friday', time: '8:00am - 12:00pm', icon: '👩‍⚕️', desc: 'General medical consultation for patients of all ages. Includes check-ups, diagnosis, and treatment recommendations.' },
  { title: 'Pre-natal Care', subtitle: 'Tuesday', time: '8:00am - 12:00pm', icon: '🤰', desc: 'Comprehensive care for pregnant women including check-ups, nutritional counseling, and monitoring of fetal development.' },
  { title: 'National Immunization Program (NIP)', subtitle: 'Wednesday to Friday', time: '8:00am - 12:00pm', icon: '💉', desc: 'Routine immunization for infants, children, and adults following the national vaccination schedule.' },
  { title: 'Hypertension Detection and Management (HDM)', subtitle: 'Monday to Friday', time: '8:00am - 12:00pm', icon: '🩸', desc: 'Blood pressure screening, monitoring, and treatment for hypertensive patients.' },
  { title: 'Visual Inspection with Acetic Acid (VIA)', subtitle: 'Thursday', time: '8:00am - 12:00pm', icon: '🔬', desc: 'Cervical cancer screening procedure for early detection of abnormalities.' },
  { title: 'Family Planning', subtitle: 'Thursday', time: '8:00am - 12:00pm', icon: '🧬', desc: 'Counseling and services for various family planning methods, reproductive health education, and informed choice.' },
  { title: 'Pills and Condoms', subtitle: 'Monday to Friday', time: '8:00am - 12:00pm', icon: '💊', desc: 'Distribution and counseling on oral contraceptive pills and condoms for safe and responsible family planning.' },
