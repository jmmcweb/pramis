      ...
      case 'feedback':
        return (
          <>
            ...
            <p className={`text-[15px] leading-relaxed m-0 ${darkMode ? 'text-[#F9FAFB]' : 'text-[#555]'}`}>Please send your feedback to <span className="font-semibold">info.pramis@gmail.com</span>.</p>
          </>
        )
      case 'terms':
        return (
