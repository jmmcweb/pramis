...
// Gets the staff directory from the database, returning a list of staff members with their IDs, names, and roles. The function handles any errors that may occur during the database query and returns a success status along with the staff data or an error message.
