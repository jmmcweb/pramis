...
import { notifyAppointment } from '@/lib/actions/appointmentManagement'
import {
  advanceQueueEntry,
  markQueueDone,
  removeQueueEntry,
...
export default function AppointmentManagementClient({
  ...
  useEffect(() => {
    document.body.style.overflow =
      showArchive || recordFor !== null || showList ? 'hidden' : ''
    return () => {
      document.body.style.overflow = ''
    }
  }, [showArchive, recordFor, showList])
  ...
  return (
    <div>
      ...
      {/* Priority queue - walk-ins are registered and tracked on the Queueing page */}
      <div className="mb-7">
