...
export default function AppointmentsScheduleClient({
  ...
  const btnAmber = `${btn} bg-amber-500 text-white hover:bg-amber-600`
      ...
      case 'APPROVED':
        return (
          <div className="flex gap-2 flex-wrap">
            ...
            <button className={btnAmber} onClick={() => noShow(a)}>
              No Show
            </button>
            <button className={btnRed} onClick={() => cancel(a)}>
              Cancel
  ...
  return (
    <div>
      ...
      <div className={cardClass}>
        <h2 className={headingClass}>Today's Schedule</h2>
        <p className={subheadingClass}>
          {today.length} appointment{today.length === 1 ? '' : 's'} booked for
          today
        </p>
        <div
        ...
        >
          <div className="overflow-x-auto">
            <table
              className="w-full border-collapse text-[16px] min-w-[860px]"
              style={{ tableLayout: 'fixed' }}
            >
              <thead>
                <tr className="bg-[#4E69D3]">
                  <th className="px-6 py-4 text-left font-bold text-white text-[16px] uppercase tracking-[1px] font-poppins w-[28%]">
                    Patient Name
                  </th>
                  <th className="px-6 py-4 text-left font-bold text-white text-[16px] uppercase tracking-[1px] font-poppins w-[18%]">
                    Service
                  </th>
                  <th className="px-6 py-4 text-left font-bold text-white text-[16px] uppercase tracking-[1px] font-poppins w-[16%]">
                    Time
                  </th>
                  <th className="px-6 py-4 text-left font-bold text-white text-[16px] uppercase tracking-[1px] font-poppins w-[12%]">
                    Status
                  </th>
                  <th className="px-6 py-4 text-left font-bold text-white text-[16px] uppercase tracking-[1px] font-poppins w-[26%]">
                    Actions
                  </th>
                </tr>
              </thead>
      ...
      <div className={cardClass}>
        <h2 className={`${headingClass} mb-[18px]`}>Upcoming Appointments</h2>
        <div
          className={`overflow-hidden rounded-2xl border ${darkMode ? 'border-[rgba(255,255,255,0.10)]' : 'border-gray-200'}`}
        >
          <div className="overflow-x-auto">
